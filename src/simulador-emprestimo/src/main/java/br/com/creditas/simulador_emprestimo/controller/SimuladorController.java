...
public class SimuladorController {
    ...
    @PostMapping()
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Simulação realizada com sucesso", content = @io.swagger.v3.oas.annotations.media.Content(schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = SimulacaoResponseDto.class))),
    ...
    @Operation(summary = "Simula um empréstimo com base nos dados fornecidos", description = "Realiza a simulação em lote de inumeros empréstimo com base nos dados do cliente e retorna os valores calculados.")
